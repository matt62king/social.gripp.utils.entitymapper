...
import com.greenfrog.utils.datastore.mapper.annotations.*;
...
public class AnnotationUtils {
    ...
    public static AutoGenerationType getAutoGenerationType(Field field) {
        return field.getAnnotation(Generated.class).value();
    }
